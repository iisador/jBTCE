...
public class InfoReceiver {
	...
	// InfoReceiver ir = new InfoReceiver(Pair.LTC_USD, "java");
	// try {
	// System.out.println(ir.getAskOrders().get(0));
	// System.out.println(ir.getBidOrders().get(0));
	// System.out.println(ir.getTrades().get(0));
	// System.out.println(ir.getTick());
	// } catch (IOException e) {
	...
	public InfoReceiver(Pair pair, String httpClient) {
