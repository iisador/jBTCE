...
public final class UserInfo {
    ...
    private UserInfo(Rights rights, Funds funds, int openOrdersCount, LocalDateTime serverTime, int transactionCount) {
        this.rights = rights;
        this.funds = funds;
    ...
    public static final class Rights {
        ...
        private Rights(int info, int trade, int withdraw) {
            this.info = info;
            this.trade = trade;
